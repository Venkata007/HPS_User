...
open class ToastView: UIView {
  ...
  private let textLabel: UILabel = {
    ...
    self.font = {
      switch UIDevice.current.userInterfaceIdiom {
      case .unspecified: return .appFont(.Medium, size: 16)
      case .phone: return .appFont(.Medium, size: 16)
